...
const headCells = [
  { id: 'type', numeric: false, disablePadding: true, label: 'Notifications Type' },
  { id: 'msg', numeric: true, disablePadding: false, label: 'Notification' },
  { id: 'time', numeric: true, disablePadding: false, label: 'Received At' }
];
...
function MessagesTable(props) {
  ...
  const rows = props.pushService.SwNotifications
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{new Date(row.time).toLocaleString()}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
